// Main results with logit without wave 1
// anLogit.do
...
eststo logit_ca_1: xtlogit contra_any croplostdummy   pass3 pass4 , fe 
estadd local fixed "\mco{Yes}" , replace
eststo logit_ct_1: xtlogit contra_trad croplostdummy   pass3 pass4 , fe 
estadd local fixed "\mco{Yes}" , replace
eststo logit_cm_1: xtlogit contra_mode croplostdummy   pass3 pass4 , fe 
estadd local fixed "\mco{Yes}" , replace
eststo logit_pr_1: xtlogit pregnant croplostdummy   pass3 pass4 , fe 
estadd local fixed "\mco{Yes}" , replace
eststo logit_br_1: xtlogit birth croplostdummy_lag  pass3 pass4 , fe 
estadd local fixed "\mco{Yes}" , replace

// base specification with interaction with wave 1 assets
eststo logit_int_ca: xtlogit contra_any croplostdummy croplostdummyXassets_w1  pass3 pass4 , fe 
eststo logit_int_ct: xtlogit contra_trad croplostdummy croplostdummyXassets_w1  pass3 pass4 , fe 
eststo logit_int_cm: xtlogit contra_mode croplostdummy croplostdummyXassets_w1  pass3 pass4 , fe 
eststo logit_int_pr: xtlogit pregnant croplostdummy croplostdummyXassets_w1  pass3 pass4 , fe 
...
file open table using `tables'/appendix_logit_wow1.tex, write replace
...
file write table "\label{tab:logit_wow1}" _n
...
esttab logit_pr_1 logit_br_1 logit_ca_1 logit_ct_1 logit_cm_1 using `tables'/appendix_logit_wow1.tex, append ///
    fragment ///
...
file open table using `tables'/appendix_logit_wow1.tex, write append
file write table "\addlinespace" _n 
file write table " & \multicolumn{5}{c}{With interaction with assets} \\" _n
file close table

esttab logit_int_pr logit_int_br logit_int_ca logit_int_ct logit_int_cm using `tables'/appendix_logit_wow1.tex, append ///
    fragment ///
	nogap nolines varwidth(55) label ///
    collabels(none) mlabels(none) eqlabels(none) ///
    nomtitles nonumber nodepvars noobs ///
