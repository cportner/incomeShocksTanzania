// Main results with log crop loss without Wave 1
// anLogCropLossNoWave1.do

// Response to R1's last question
...
eststo lnfe_c_a:  xtreg contra_any ln_croplostamount_pc   pass3 pass4 , fe cluster(id_hh)
estadd local fixed "\mco{Yes}" , replace
eststo lnfe_c_tr: xtreg contra_trad ln_croplostamount_pc   pass3 pass4 , fe cluster(id_hh)
estadd local fixed "\mco{Yes}" , replace
eststo lnfe_c_mo: xtreg contra_mode ln_croplostamount_pc   pass3 pass4 , fe cluster(id_hh)
estadd local fixed "\mco{Yes}" , replace
eststo lnfe_pr:   xtreg pregnant ln_croplostamount_pc   pass3 pass4 , fe cluster(id_hh)
estadd local fixed "\mco{Yes}" , replace
...
eststo lnfe_int_c_a:  xtreg contra_any ln_croplostamount_pc ln_croplostXassets_w1  pass3 pass4 , fe cluster(id_hh)
eststo lnfe_int_c_tr: xtreg contra_trad ln_croplostamount_pc ln_croplostXassets_w1  pass3 pass4 , fe cluster(id_hh)
eststo lnfe_int_c_mo: xtreg contra_mode ln_croplostamount_pc ln_croplostXassets_w1  pass3 pass4 , fe cluster(id_hh)
eststo lnfe_int_pr:   xtreg pregnant ln_croplostamount_pc ln_croplostXassets_w1  pass3 pass4 , fe cluster(id_hh)
...
eststo lnlnfe_int_c_a:  xtreg contra_any ln_croplostamount_pc ln_croplostXln_assets_w1  pass3 pass4 , fe cluster(id_hh)
eststo lnlnfe_int_c_tr: xtreg contra_trad ln_croplostamount_pc ln_croplostXln_assets_w1  pass3 pass4 , fe cluster(id_hh)
eststo lnlnfe_int_c_mo: xtreg contra_mode ln_croplostamount_pc ln_croplostXln_assets_w1  pass3 pass4 , fe cluster(id_hh)
eststo lnlnfe_int_pr:   xtreg pregnant ln_croplostamount_pc ln_croplostXln_assets_w1  pass3 pass4 , fe cluster(id_hh)
...
file open table using `tables'/appendix_log_croploss_wow1.tex, write replace
...
file write table "\label{tab:ln_croploss_wow1}" _n
...
esttab lnfe_pr lnfe_br lnfe_c_a lnfe_c_tr lnfe_c_mo using `tables'/appendix_log_croploss_wow1.tex, append ///
    fragment ///
...
file open table using `tables'/appendix_log_croploss_wow1.tex, write append
file write table "\addlinespace" _n 
file write table " & \multicolumn{5}{c}{With interaction with assets} \\" _n
file close table

esttab lnfe_int_pr lnfe_int_br lnfe_int_c_a lnfe_int_c_tr lnfe_int_c_mo using `tables'/appendix_log_croploss_wow1.tex, append ///
    fragment ///
	nogap nolines varwidth(55) label ///
    collabels(none) mlabels(none) eqlabels(none) ///
    nomtitles nonumber nodepvars noobs ///
...
esttab lnlnfe_int_pr lnlnfe_int_br lnlnfe_int_c_a lnlnfe_int_c_tr lnlnfe_int_c_mo using `tables'/appendix_log_croploss_wow1.tex, append ///
    fragment ///
	nogap nolines varwidth(55) label ///
    collabels(none) mlabels(none) eqlabels(none) ///
    nomtitles nonumber nodepvars noobs ///
