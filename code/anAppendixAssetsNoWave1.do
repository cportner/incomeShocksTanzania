// Main results with assets interactions excluding wave 1
// anAppendixAssetsNoWave1.do
...
eststo d_int_ca: xtreg contra_any croplostdummy croplostdummyXassets_w1  pass3 pass4 , fe cluster(id_hh)
estadd local fixed "\mco{Yes}" , replace
eststo d_int_ct: xtreg contra_trad croplostdummy croplostdummyXassets_w1  pass3 pass4 , fe cluster(id_hh)
estadd local fixed "\mco{Yes}" , replace
eststo d_int_cm: xtreg contra_mode croplostdummy croplostdummyXassets_w1  pass3 pass4 , fe cluster(id_hh)
estadd local fixed "\mco{Yes}" , replace
eststo d_int_pr: xtreg pregnant croplostdummy croplostdummyXassets_w1  pass3 pass4 , fe cluster(id_hh)
estadd local fixed "\mco{Yes}" , replace
...
file open table using `tables'/appendix_asset_interaction_wow1.tex, write replace
...
file write table "\label{tab:assets_wow1}" _n
...
esttab d_int_pr d_int_br d_int_ca d_int_ct d_int_cm using `tables'/appendix_asset_interaction_wow1.tex, append ///
    fragment ///
...
file open table using `tables'/appendix_asset_interaction_wow1.tex, write append
