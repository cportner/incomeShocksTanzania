// Main results with clustering at community level
// anCommunityCluster.do
...
eststo lpm_ca_0: reg contra_any croplostdummy  pass2 pass3 pass4 `xvar', cluster(cluster)
estadd local fixed "\mco{No}" , replace
eststo lpm_ct_0: reg contra_trad croplostdummy  pass2 pass3 pass4 `xvar', cluster(cluster)
estadd local fixed "\mco{No}" , replace
eststo lpm_cm_0: reg contra_mode croplostdummy  pass2 pass3 pass4 `xvar', cluster(cluster)
estadd local fixed "\mco{No}" , replace
eststo lpm_pr_0: reg pregnant croplostdummy  pass2 pass3 pass4 `xvar', cluster(cluster)
estadd local fixed "\mco{No}" , replace
eststo lpm_br_0: reg birth croplostdummy_lag  pass3 pass4 `xvar', cluster(cluster)
estadd local fixed "\mco{No}" , replace
...
eststo lpm_ca_1: reg contra_any croplostdummy  pass2 pass3 pass4 `xvar', cluster(cluster)
estadd local fixed "\mco{No}" , replace
eststo lpm_ct_1: reg contra_trad croplostdummy  pass2 pass3 pass4 `xvar', cluster(cluster)
estadd local fixed "\mco{No}" , replace
eststo lpm_cm_1: reg contra_mode croplostdummy  pass2 pass3 pass4 `xvar', cluster(cluster)
estadd local fixed "\mco{No}" , replace
eststo lpm_pr_1: reg pregnant croplostdummy  pass2 pass3 pass4 `xvar', cluster(cluster)
estadd local fixed "\mco{No}" , replace
eststo lpm_br_1: reg birth croplostdummy_lag  pass3 pass4 `xvar', cluster(cluster)
estadd local fixed "\mco{No}" , replace

// Woman fixed effects base specification without wave 1 asset interaction
eststo d_ca_1: xtreg contra_any croplostdummy  pass2 pass3 pass4 , fe cluster(cluster)
estadd local fixed "\mco{Yes}" , replace
eststo d_ct_1: xtreg contra_trad croplostdummy  pass2 pass3 pass4 , fe cluster(cluster)
estadd local fixed "\mco{Yes}" , replace
eststo d_cm_1: xtreg contra_mode croplostdummy  pass2 pass3 pass4 , fe cluster(cluster)
estadd local fixed "\mco{Yes}" , replace
eststo d_pr_1: xtreg pregnant croplostdummy  pass2 pass3 pass4 , fe cluster(cluster)
estadd local fixed "\mco{Yes}" , replace
eststo d_br_1: xtreg birth croplostdummy_lag  pass3 pass4 , fe cluster(cluster)
estadd local fixed "\mco{Yes}" , replace
...
file open table using `tables'/appendix_cluster_contraceptives.tex, write replace
file write table "\begin{table}[htbp]" _n
file write table "\begin{center}" _n
file write table "\begin{threeparttable}" _n
file write table "\caption{The Effects of Crop Loss on Contraceptive\\ Use Overall and By Type with Clustering at Community Level}" _n
file write table "\label{tab:com_cluster_contraceptive}" _n
...
esttab lpm_ca_0 lpm_ca_1 d_ca_1  using `tables'/appendix_cluster_contraceptives.tex, append ///
    fragment ///
...
file open table using `tables'/appendix_cluster_contraceptives.tex, write append
file write table "\addlinespace" _n
file write table _col(56) "&\multicolumn{3}{c}{Traditional contraception}  \\ \cmidrule(lr){2-4} " _n
file close table

esttab lpm_ct_0 lpm_ct_1  d_ct_1 using `tables'/appendix_cluster_contraceptives.tex, append ///
    fragment ///
	nogap nolines varwidth(55) label ///
    collabels(none) mlabels(none) eqlabels(none) ///
    nomtitles nonumber nodepvars noobs ///
...
esttab lpm_cm_0 lpm_cm_1  d_cm_1 using `tables'/appendix_cluster_contraceptives.tex, append ///
    fragment ///
	nogap nolines varwidth(55) label ///
    collabels(none) mlabels(none) eqlabels(none) ///
    nomtitles nonumber nodepvars noobs ///
