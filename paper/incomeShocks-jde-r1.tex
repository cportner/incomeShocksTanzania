...
\begin{figure}[ht] 
 \centering
 \includegraphics[width=0.6\textwidth]{../map/kagera.pdf}
...
\begin{tabular}{l  D{.}{.}{2,3} D{.}{.}{2,3} D{.}{.}{2,3} D{.}{.}{2,3} D{.}{.}{2,3}} \toprule
                                  & \multicolumn{4}{c}{Wave} & \mco{Average} \\ \cmidrule(lr){2-5}
...
Contraceptive use -- Traditional\tnote{a}              &        0.11&        0.06&        0.07&        0.04&        0.07\\
                                                       &      (0.32)&      (0.24)&      (0.25)&      (0.21)&      (0.26)\\
Contraceptive use -- Modern\tnote{b}                   &        0.04&        0.02&        0.02&        0.05&        0.03\\
...
Assets per capita in wave 1 (10,000 TZS)\tnote{a}      &        7.67&       12.75\\ \addlinespace 
...
\begin{center}
\begin{threeparttable}
\caption{The Effects of Crop Loss on Pregnancy and Births}
\label{tab:birth}
\begin{tabular}{@{} l D{.}{.}{1.5} D{.}{.}{1.5} D{.}{.}{1.5} D{.}{.}{1.5} D{.}{.}{1.5} D{.}{.}{1.5}  @{}}
\toprule
                                                       &\multicolumn{3}{c}{Currently pregnant}&\multicolumn{3}{c}{Birth since last survey}\\ \cmidrule(lr){2-4} \cmidrule(lr){5-7}
                                                       &                     & \mct{Fixed Effects}                       &                     & \mct{Fixed Effects}                       \\ \cmidrule(lr){3-4} \cmidrule(lr){6-7}
                                                       & \mco{OLS}           & \mco{Community}     & \mco{Woman}         & \mco{OLS}           & \mco{Community}     & \mco{Woman}         \\ \midrule
Crop loss - 1-7 months                                 &      -0.053         &      -0.074\sym{*}  &      -0.093\sym{**} &                     &                     &                     \\
\hs (200 TZS or above)                                 &     (0.038)         &     (0.039)         &     (0.043)         &                     &                     &                     \\
Crop loss - 7-14 months                                &                     &                     &                     &      -0.103\sym{***}&      -0.115\sym{***}&      -0.159\sym{***}\\
\hs (200 TZS or above)                                 &                     &                     &                     &     (0.040)         &     (0.042)         &     (0.050)         \\
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Community fixed effects                                &    \mco{No}         &    \mco{Yes}        &    \mco{No}         &    \mco{No}         &    \mco{Yes}        &    \mco{No}         \\
Woman fixed effects                                    &    \mco{No}         &    \mco{No}         &    \mco{Yes}        &    \mco{No}         &    \mco{No}         &    \mco{Yes}        \\
Observations                                           &    \mco{988}        &    \mco{988}        &    \mco{988}        &    \mco{741}        &    \mco{741}        &    \mco{741}        \\
Number of women                                        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        \\
\bottomrule    
\end{tabular}
...
Crop loss is a dummy for a per capita crop loss of 200 TZS or above.
% Assets are per capita and measured in 10,000 TZS.
\end{tablenotes}
\end{threeparttable}
\end{center}
\end{table}
...
\begin{center}
\begin{threeparttable}
\caption{The Effects of Crop Loss on Contraceptive\\ Use Overall and By Type}
\label{tab:contraceptive}
\begin{tabular}{@{} l D{.}{.}{2.6}  D{.}{.}{2.6} D{.}{.}{2.6}  @{}}
\toprule
                                                       &                     & \mct{Fixed Effects}                       \\ \cmidrule(lr){3-4} 
                                                       & \mco{OLS}           & \mco{Community}     & \mco{Woman}         \\ \midrule
                                                       &\multicolumn{3}{c}{Any contraception}  \\ \cmidrule(lr){2-4}
Crop loss - 1-7 months (200 TZS or above)              &       0.061\sym{**} &       0.059\sym{**} &       0.070\sym{**} \\
                                                       &     (0.027)         &     (0.027)         &     (0.033)         \\
\addlinespace 
                                                       &\multicolumn{3}{c}{Traditional contraception}  \\ \cmidrule(lr){2-4}
Crop loss - 1-7 months (200 TZS or above)              &       0.052\sym{**} &       0.048\sym{**} &       0.054\sym{**} \\
                                                       &     (0.023)         &     (0.022)         &     (0.024)         \\
\addlinespace 
                                                       &\multicolumn{3}{c}{Modern contraception}  \\ \cmidrule(lr){2-4}
Crop loss - 1-7 months (200 TZS or above)              &      -0.001         &       0.004         &       0.003         \\
                                                       &     (0.014)         &     (0.013)         &     (0.020)         \\
\addlinespace                                                        
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Community fixed effects                                &    \mco{No}         &    \mco{Yes}        &    \mco{No}         \\
Woman fixed effects                                    &    \mco{No}         &    \mco{No}         &    \mco{Yes}        \\
Observations                                           &    \mco{988}        &    \mco{988}        &    \mco{988}        \\
...
\begin{center}
\begin{threeparttable}
\caption{The Effects of Crop Loss on Women's Health, Absence of Partner, and Marriage Dissolution}
\label{tab:health}
\begin{tabular}{@{} l D{.}{.}{2.6} D{.}{.}{2.6}  @{}}
\toprule
                                                       & \mct{Respondent} \\
													   & \mco{BMI}           &  \mco{Illness}  	       \\ \midrule
Crop loss - 1-7 months (200 TZS or above)              &      -0.014         &       0.023         \\
                                                       &     (0.016)         &     (0.047)         \\
Pregnant                                               &       0.083\sym{***}&                     \\
                                                       &     (0.013)         &                     \\
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        \\
Woman fixed effects                                    &    \mco{Yes}        &    \mco{Yes}        \\
Observations                                           &    \mco{988}        &    \mco{988}        \\
Number of women                                        &    \mco{247}        &    \mco{247}        \\ 
\addlinespace 
                                                       &\mco{Absence/migration}&\mco{Dissolution of}\\
                                                       &\mco{of partner}     &\mco{ of marriage}\\ \midrule
Crop loss - 1-7 months (200 TZS or above)              &       0.011         &      -0.001         \\
                                                       &     (0.011)         &     (0.012)         \\
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        \\
Woman fixed effects                                    &    \mco{Yes}        &    \mco{Yes}       \\
...
\begin{center}
\begin{threeparttable}
\caption{Contraceptive Use and Pregnancy}
\label{tab:effectiveness}
\begin{tabular}{@{} l  D{.}{.}{2.6} D{.}{.}{2.6} D{.}{.}{2.6}  @{}}
\toprule
                                                       & \multicolumn{3}{c}{Currently Pregnant} \\ \cmidrule(lr){2-4}
                                                       &\mco{Any}            & \mco{Traditional}   & \mco{Modern}        \\ \midrule
Contraceptives (7 months)                              &       0.174\sym{**} &       0.161\sym{**} &       0.300\sym{*}  \\
                                                       &     (0.067)         &     (0.066)         &     (0.167)         \\
Crop loss (7-14 months) \X Any Contraceptive (7 months)&      -0.253\sym{**} &      -0.254\sym{**} &      -0.314         \\
                                                       &     (0.110)         &     (0.113)         &     (0.235)         \\
Crop loss - 7-14 months (200 TZS or above)             &       0.047         &       0.039         &       0.031         \\
                                                       &     (0.051)         &     (0.052)         &     (0.049)         \\
\addlinespace 
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Woman fixed effects                                    &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Observations                                           &    \mco{741}        &    \mco{741}        &    \mco{741}        \\
Number of women                                        &    \mco{247}        &    \mco{247}        &    \mco{247}        \\
\bottomrule
\end{tabular}
\begin{tablenotes} \footnotesize
...
% Attrition descriptive statistics
...
Contraceptive use -- Traditional\tnote{a}              &        0.08&        0.10&        0.05&        0.11&        0.08\\
                                                       &      (0.27)&      (0.30)&      (0.23)&      (0.32)&      (0.28)\\
Contraceptive use -- Modern\tnote{b}                   &        0.05&        0.07&        0.09&        0.07&        0.06\\
...
\begin{threeparttable}
\caption{Wave 1 Descriptive Statistics for Women}
\label{tab:attrition_desc_stat_women}
\begin{tabular}{l  D{.}{.}{3,2} D{.}{.}{3,2} D{.}{.}{3,2} D{.}{.}{3,2}} \toprule
                            	 & \mco{Mean} 	 & 	\mco{St Dev}	  \\ \midrule
Age 18-22                                              &        0.29&        0.45\\
Age 23-27                                              &        0.17&        0.38\\
...
Age 38-45                                              &        0.22&        0.41\\ 
\addlinespace 
No education                                           &        0.23&        0.42\\
1 - 6 years of education                               &        0.24&        0.43\\
7 plus years of education                              &        0.53&        0.50\\ 
\addlinespace 
Assets per capita in wave 1 (10,000 TZS)\tnote{a}      &        9.24&       21.44\\
\addlinespace 
Number of women                                        &     \mct{207}           \\
\bottomrule
\end{tabular}
\begin{tablenotes} 
\scriptsize
...
\begin{small}
\begin{threeparttable}
\caption{Full OLS and Community Fixed Effects Results for Fertility Outcomes}
\label{tab:ols_fertility}
\begin{tabular}{@{} l D{.}{.}{2.6} D{.}{.}{2.6}  D{.}{.}{2.6} D{.}{.}{2.6} @{}}
\toprule
                                                       &\multicolumn{2}{c}{Currently pregnant}&\multicolumn{2}{c}{Birth since last survey}\\ \cmidrule(lr){2-3} \cmidrule(lr){4-5}
                                                       &                     & \mco{Community}     &                     & \mco{Community}      \\ 
                                                       & \mco{OLS}           & \mco{Fixed Effects} & \mco{OLS}           & \mco{Fixed Effects}  \\ 
\midrule
Crop loss - 1-7 months (200 TZS or above)              &      -0.053         &      -0.074\sym{*}  &                     &                     \\
                                                       &     (0.038)         &     (0.039)         &                     &                     \\
Crop loss - 7-14 months (200 TZS or above)             &                     &                     &      -0.103\sym{***}&      -0.115\sym{***}\\
                                                       &                     &                     &     (0.040)         &     (0.042)         \\
Assets per capita in wave 1 (10,000 TZS)               &      -0.001         &      -0.002\sym{**} &       0.000         &       0.001         \\
                                                       &     (0.001)         &     (0.001)         &     (0.001)         &     (0.001)         \\
1 - 6 years of education                               &      -0.011         &      -0.005         &       0.006         &       0.006         \\
                                                       &     (0.027)         &     (0.027)         &     (0.029)         &     (0.032)         \\
7 plus years of education                              &      -0.016         &       0.002         &       0.026         &       0.042         \\
                                                       &     (0.028)         &     (0.029)         &     (0.029)         &     (0.029)         \\
Age 23-27                                              &       0.017         &       0.022         &      -0.036         &      -0.027         \\
                                                       &     (0.033)         &     (0.036)         &     (0.033)         &     (0.032)         \\
Age 28-32                                              &      -0.037         &      -0.033         &      -0.060\sym{*}  &      -0.059\sym{*}  \\
                                                       &     (0.031)         &     (0.034)         &     (0.034)         &     (0.034)         \\
Age 33-37                                              &      -0.079\sym{**} &      -0.068\sym{**} &      -0.055         &      -0.057         \\
                                                       &     (0.032)         &     (0.034)         &     (0.035)         &     (0.036)         \\
Age 38-45                                              &      -0.174\sym{***}&      -0.156\sym{***}&      -0.184\sym{***}&      -0.194\sym{***}\\
                                                       &     (0.034)         &     (0.036)         &     (0.032)         &     (0.035)         \\
Constant                                               &       0.270\sym{***}&       0.293\sym{***}&       0.278\sym{***}&       0.237\sym{**} \\
                                                       &     (0.048)         &     (0.091)         &     (0.048)         &     (0.103)         \\
\addlinespace 
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Community fixed effects                                &    \mco{No}         &    \mco{Yes}        &    \mco{No}         &    \mco{Yes}        \\
Woman fixed effects                                    &    \mco{No }        &    \mco{No }        &    \mco{No }        &    \mco{No }        \\
Observations                                           &    \mco{988}        &    \mco{741}        &    \mco{988}        &    \mco{988}        \\
Number of women                                        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        \\
\bottomrule
\end{tabular}
\begin{tablenotes} \footnotesize
\item \hspace*{-0.5em} \textbf{Note.}
...
\begin{footnotesize}
\begin{threeparttable}
\caption{Full OLS and Community Fixed Effects Results for Contraceptive Use}
\label{tab:ols_contraceptive}
\begin{tabular}{@{} l D{.}{.}{2.6} D{.}{.}{2.6}  D{.}{.}{2.6} D{.}{.}{2.6} D{.}{.}{2.6} D{.}{.}{2.6} D{.}{.}{2.6}  @{}}
\toprule
                                                       &                    \mct{Any}              &  \mct{Traditional}                        & \mct{Modern}        \\  \cmidrule(lr){2-3} \cmidrule(lr){4-5} \cmidrule(lr){6-7}
                                                       &                     & \mco{Community}     &                     & \mco{Community}     &                     & \mco{Community}      \\ 
                                                       & \mco{OLS}           & \mco{Fixed Effects} & \mco{OLS}           & \mco{Fixed Effects} & \mco{OLS}           & \mco{Fixed Effects}  \\ 
...
Age 33-37                                              &       0.072\sym{*}  &       0.075\sym{*}  &       0.061\sym{*}  &       0.084\sym{**} &       0.048\sym{*}  &       0.018         \\
                                                       &     (0.040)         &     (0.043)         &     (0.035)         &     (0.036)         &     (0.029)         &     (0.023)         \\
Age 38-45                                              &       0.045         &       0.044         &       0.033         &       0.028         &       0.024         &       0.010         \\
                                                       &     (0.047)         &     (0.061)         &     (0.038)         &     (0.047)         &     (0.021)         &     (0.022)         \\
Constant                                               &      -0.005         &      -0.014         &       0.007         &      -0.002         &      -0.021         &      -0.017         \\
                                                       &     (0.040)         &     (0.065)         &     (0.035)         &     (0.056)         &     (0.018)         &     (0.024)         \\
\addlinespace 
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Community dummies                                      &    \mco{No}         &    \mco{Yes}        &    \mco{No}         &    \mco{Yes}        &    \mco{No}         &    \mco{Yes}        \\
Woman fixed effects                                    &    \mco{No }        &    \mco{No }        &    \mco{No }        &    \mco{No }        &    \mco{No }        &    \mco{No }        \\
Observations                                           &    \mco{988}        &    \mco{988}        &    \mco{988}        &    \mco{988}        &    \mco{988}        &    \mco{988}        \\
Number of women                                        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        \\
\bottomrule
\end{tabular}
...
% Community level clustering for two main tables
...
\begin{threeparttable}
\caption{The Effects of Crop Loss on Pregnancy and Births}
\label{tab:com_cluster_birth}
\begin{tabular}{@{} l D{.}{.}{1.5} D{.}{.}{1.5} D{.}{.}{1.5} D{.}{.}{1.5} D{.}{.}{1.5} D{.}{.}{1.5}  @{}}
\toprule
                                                       &\multicolumn{3}{c}{Currently pregnant}&\multicolumn{3}{c}{Birth since last survey}\\ \cmidrule(lr){2-4} \cmidrule(lr){5-7}
                                                       &                     & \mct{Fixed Effects}                       &                     & \mct{Fixed Effects}                       \\ \cmidrule(lr){3-4} \cmidrule(lr){6-7}
                                                       & \mco{OLS}           & \mco{Community}     & \mco{Woman}         & \mco{OLS}           & \mco{Community}     & \mco{Woman}         \\ \midrule
Crop loss - 1-7 months                                 &      -0.053         &      -0.074         &      -0.093\sym{*}  &                     &                     &                     \\
\hs (200 TZS or above)                                 &     (0.041)         &     (0.045)         &     (0.049)         &                     &                     &                     \\
Crop loss - 7-14 months                                &                     &                     &                     &      -0.103\sym{***}&      -0.115\sym{***}&      -0.159\sym{***}\\
\hs (200 TZS or above)                                 &                     &                     &                     &     (0.036)         &     (0.039)         &     (0.046)         \\
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Community fixed effects                                &    \mco{No}         &    \mco{Yes}        &    \mco{No}         &    \mco{No}         &    \mco{Yes}        &    \mco{No}         \\
Woman fixed effects                                    &    \mco{No}         &    \mco{No}         &    \mco{Yes}        &    \mco{No}         &    \mco{No}         &    \mco{Yes}        \\
Observations                                           &    \mco{988}        &    \mco{988}        &    \mco{988}        &    \mco{741}        &    \mco{741}        &    \mco{741}        \\
...
\begin{threeparttable}
\caption{The Effects of Crop Loss on Contraceptive\\ Use Overall and By Type}
\label{tab:com_cluster_contraceptive}
\begin{tabular}{@{} l D{.}{.}{2.6}  D{.}{.}{2.6} D{.}{.}{2.6}  @{}}
\toprule
                                                       &                     & \mct{Fixed Effects}                       \\ \cmidrule(lr){3-4} 
                                                       & \mco{OLS}           & \mco{Community}     & \mco{Woman}         \\ \midrule
...
\begin{small}
\begin{threeparttable}
\caption{The Effects of Crop Loss -- Logit Fixed Effects Estimates}
\label{tab:logit}
\begin{tabular}{@{} l D{.}{.}{2.6} D{.}{.}{2.6}  D{.}{.}{2.6} D{.}{.}{2.6} D{.}{.}{2.6}  @{}}
\toprule
                                                       & \mco{}              &\mco{}               &\multicolumn{3}{c}{Contraceptive Use}\\ \cmidrule(lr){4-6}
                                                       & \mco{Pregnant}      &\mco{Birth}          &\mco{Any}            &\mco{Traditional}    & \mco{Modern}        \\ \midrule
 & \multicolumn{5}{l}{Without interaction with assets} \\
Crop loss - 1-7 months                                 &      -0.607\sym{**} &                     &       0.804\sym{**} &       0.764\sym{*}  &       0.299         \\
                                                       &     (0.274)         &                     &     (0.390)         &     (0.444)         &     (0.691)         \\
Crop loss - 7-14 months                                &                     &      -0.946\sym{***}&                     &                     &                     \\
                                                       &                     &     (0.294)         &                     &                     &                     \\
\addlinespace 
 & \multicolumn{5}{l}{With interaction with assets} \\
Crop loss - 1-7 months                                 &      -0.570\sym{*}  &                     &       1.107\sym{**} &       0.934\sym{*}  &       1.379         \\
                                                       &     (0.335)         &                     &     (0.449)         &     (0.500)         &     (0.945)         \\
Crop loss - 1-7 months                                 &      -0.006         &                     &      -0.027         &      -0.013         &      -0.070         \\
\hs \X initial assets (10,000 TZS)                                                       &     (0.032)         &                     &     (0.021)         &     (0.019)         &     (0.045)         \\
Crop loss - 7-14 months                                &                     &      -0.952\sym{***}&                     &                     &                     \\
                                                       &                     &     (0.337)         &                     &                     &                     \\
Crop loss - 7-14 months                                &                     &       0.001         &                     &                     &                     \\
\hs \X initial assets (10,000 TZS)                     &                     &     (0.020)         &                     &                     &                     \\
\addlinespace 
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Woman fixed effects                                    &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Observations                                           &    \mco{560}        &    \mco{360}        &    \mco{300}        &    \mco{228}        &     \mco{88}        \\
Number of women                                        &    \mco{140}        &    \mco{120}        &     \mco{75}        &     \mco{57}        &     \mco{22}        \\
\bottomrule
\end{tabular}
\begin{tablenotes} \footnotesize
\item \hspace*{-0.5em} \textbf{Note.}
...
\begin{small}
\begin{threeparttable}
\caption{The Effects of Log Crop Loss}
\label{tab:ln_croploss}
\begin{tabular}{@{} l D{.}{.}{2.6} D{.}{.}{2.6}  D{.}{.}{2.6} D{.}{.}{2.6} D{.}{.}{2.6}  @{}}
\toprule
                                                       & \mco{}              &\mco{}               &\multicolumn{3}{c}{Contraceptive Use}\\ \cmidrule(lr){4-6}
                                                       & \mco{Pregnant}      &\mco{Birth}          &\mco{Any}            &\mco{Traditional}    & \mco{Modern}        \\ \midrule
 & \multicolumn{5}{c}{Without interaction with assets} \\
Log crop loss - 1-7 months                             &      -0.102\sym{*}  &                     &       0.322\sym{***}&       0.333\sym{***}&      -0.013         \\
                                                       &     (0.060)         &                     &     (0.062)         &     (0.060)         &     (0.025)         \\
Log crop loss - 7-14 months                            &                     &      -0.119\sym{*}  &                     &                     &                     \\
                                                       &                     &     (0.061)         &                     &                     &                     \\
\addlinespace 
 & \multicolumn{5}{c}{With interaction with assets} \\
Log crop loss - 1-7 months                             &      -0.135\sym{*}  &                     &       0.360\sym{***}&       0.353\sym{***}&       0.012         \\
                                                       &     (0.070)         &                     &     (0.086)         &     (0.083)         &     (0.023)         \\
Log crop loss - 1-7 months                             &       0.002\sym{*}  &                     &      -0.002         &      -0.001         &      -0.002         \\
\hs \X initial assets (10,000 TZS)                     &     (0.001)         &                     &     (0.005)         &     (0.004)         &     (0.001)         \\
Log crop loss - 7-14 months                            &                     &      -0.149\sym{**} &                     &                     &                     \\
                                                       &                     &     (0.075)         &                     &                     &                     \\
Log crop loss - 7-14 months                            &                     &       0.002         &                     &                     &                     \\
\hs \X initial assets (10,000 TZS)                     &                     &     (0.002)         &                     &                     &                     \\
\addlinespace 
 & \multicolumn{5}{c}{With interaction with log assets} \\
...
Robust standard errors clustered at household level in parentheses; 
* significant at 10\%; ** significant at 5\%; *** significant at 1\%.
Crop loss is log per capita crop loss plus 1.
Assets are assets per capita in round 1 of the survey and are measured in 10,000 TZS.
Log of assets are taken off assets per capita in TZS.
\end{tablenotes}
\end{threeparttable}
\end{small}
\end{center}
...
\begin{small}
\begin{threeparttable}
\caption{The Effects of Crop Loss Using Continuous Measure}
...
\toprule
                                                       ...
                                                       & \mco{Pregnant}      &\mco{Birth}          &\mco{Any}            &\mco{Traditional}    & \mco{Modern}        \\ \midrule
 & \multicolumn{5}{c}{Without interaction with assets} \\
Crop loss - 1-7 months (10,000 TZS)                    &      -0.022         &                     &       0.102\sym{***}&       0.114\sym{***}&      -0.013         \\
                                                       &     (0.018)         &                     &     (0.030)         &     (0.023)         &     (0.008)         \\
Crop loss - 7-14 months (10,000 TZS)                   &                     &      -0.023         &                     &                     &                     \\
                                                       &                     &     (0.017)         &                     &                     &                     \\
\addlinespace 
 & \multicolumn{5}{c}{With interaction with assets} \\
Crop loss - 1-7 months (10,000 TZS)                    &      -0.041\sym{*}  &                     &       0.124\sym{***}&       0.127\sym{***}&      -0.003         \\
                                                       &     (0.024)         &                     &     (0.038)         &     (0.033)         &     (0.008)         \\
Crop loss - 1-7 months                                 &       0.001         &                     &      -0.001         &      -0.001         &      -0.001         \\
\hs \X initial assets (10,000 TZS)                     &     (0.001)         &                     &     (0.002)         &     (0.002)         &     (0.000)         \\
Crop loss - 7-14 months (10,000 TZS)                   &                     &      -0.039         &                     &                     &                     \\
                                                       &                     &     (0.025)         &                     &                     &                     \\
Crop loss - 7-14 months                                &                     &       0.001         &                     &                     &                     \\
\hs \X initial assets (10,000 TZS)                     &                     &     (0.001)         &                     &                     &                     \\
\addlinespace 
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Woman fixed effects                                    &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Observations                                           &    \mco{988}        &    \mco{741}        &    \mco{988}        &    \mco{988}        &    \mco{988}        \\
...
Robust standard errors clustered at household level in parentheses; 
* significant at 10\%; ** significant at 5\%; *** significant at 1\%.
Crop loss is a per capita crop loss and measured in 10,000 TZS.
Assets are assets per capita in round 1 of the survey and are measured in 10,000 TZS.
\end{tablenotes}
\end{threeparttable}
\end{small}
...
\begin{small}
\begin{threeparttable}
\caption{The Effects of Crop Loss by Age}
\label{tab:agegroups}
\begin{tabular}{@{} l D{.}{.}{2.6} D{.}{.}{2.6}  D{.}{.}{2.6} D{.}{.}{2.6} D{.}{.}{2.6}  @{}}
\toprule
                                                       & \mco{}              &\mco{}               &\multicolumn{3}{c}{Contraceptive Use}\\ \cmidrule(lr){4-6}
                                                       & \mco{Pregnant}      &\mco{Birth}          &\mco{Any}            &\mco{Traditional}    & \mco{Modern}        \\ \midrule
Crop loss - 1-7 months \X age 18-22                    &      -0.160\sym{**} &                     &       0.096\sym{*}  &       0.048         &      -0.003         \\
                                                       &     (0.075)         &                     &     (0.052)         &     (0.044)         &     (0.016)         \\
Crop loss - 1-7 months \X age 23-27                    &      -0.170\sym{**} &                     &       0.004         &      -0.017         &       0.009         \\
                                                       &     (0.072)         &                     &     (0.066)         &     (0.063)         &     (0.019)         \\
Crop loss - 1-7 months \X age 28-32                    &      -0.153\sym{**} &                     &       0.149\sym{**} &       0.126\sym{**} &       0.029         \\
                                                       &     (0.065)         &                     &     (0.058)         &     (0.055)         &     (0.031)         \\
Crop loss - 1-7 months \X age 33-37                    &       0.031         &                     &       0.048         &       0.038         &       0.001         \\
                                                       &     (0.072)         &                     &     (0.070)         &     (0.055)         &     (0.044)         \\
Crop loss - 1-7 months \X age 38-45                    &      -0.021         &                     &       0.020         &       0.050         &      -0.034\sym{*}  \\
                                                       &     (0.043)         &                     &     (0.054)         &     (0.048)         &     (0.020)         \\
Crop loss - 7-14 months \X age 18-22                   &                     &      -0.235\sym{***}&                     &                     &                     \\
                                                       &                     &     (0.087)         &                     &                     &                     \\
Crop loss - 7-14 months \X age 23-27                   &                     &      -0.129         &                     &                     &                     \\
                                                       &                     &     (0.094)         &                     &                     &                     \\
Crop loss - 7-14 months \X age 28-32                   &                     &      -0.225\sym{***}&                     &                     &                     \\
                                                       &                     &     (0.073)         &                     &                     &                     \\
Crop loss - 7-14 months \X age 33-37                   &                     &      -0.127         &                     &                     &                     \\
                                                       &                     &     (0.082)         &                     &                     &                     \\
Crop loss - 7-14 months \X age 38-45                   &                     &      -0.042         &                     &                     &                     \\
                                                       &                     &     (0.050)         &                     &                     &                     \\
\addlinespace 
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Woman fixed effects                                    &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
...
* significant at 10\%; ** significant at 5\%; *** significant at 1\%.
Crop loss is a dummy for a per capita crop loss of 200 TZS or above.
Age groups is based on age at the first round of the survey as described in the text.
\end{tablenotes}
\end{threeparttable}
\end{small}
\end{center}
...
\begin{tabular}{@{} l D{.}{.}{2.6}  D{.}{.}{2.6} D{.}{.}{2.6} D{.}{.}{2.6} D{.}{.}{2.6}   @{}}
\toprule
                                                       &\multicolumn{5}{c}{Hours worked by woman} \\ \midrule
...
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Woman fixed effects                                    &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Observations                                           &    \mco{982}        &    \mco{982}        &    \mco{982}        &    \mco{982}        &    \mco{982}        \\
Number of women                                        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        \\
\bottomrule
\end{tabular}
\begin{tablenotes} \footnotesize
...
Crop loss is a dummy for a per capita crop loss of 200 TZS or above.
Assets are per capita and measured in 10,000 TZS.
Log crop loss is log per capita crop loss plus 1.
Log of assets are taken off assets per capita in TZS.
\end{tablenotes}
\end{threeparttable}
\end{small}
...
\begin{small}
\begin{threeparttable}
\caption{Crop loss and Abstinence as Contraceptives}
\label{tab:excludeAbs}
\begin{tabular}{@{} l D{.}{.}{2.6} D{.}{.}{2.6}  D{.}{.}{2.6} D{.}{.}{2.6} D{.}{.}{2.6} D{.}{.}{2.6}   @{}}
\toprule
                                                       & \multicolumn{4}{c}{Contraceptive Use}\\ \cmidrule(lr){2-5}
                                                       & \mct{Any, except abstinence}              & \mct{Rhythm and withdrawal}               & \mct{Only abstinence}                     \\ \midrule
Crop loss - 1-7 months                                 &       0.036         &       0.039         &       0.018         &       0.002         &       0.021         &       0.025         \\
\hs (200 TZS or above)                                 &     (0.030)         &     (0.031)         &     (0.021)         &     (0.026)         &     (0.019)         &     (0.027)         \\
Crop loss - 1-7 months                                 &                     &      -0.000         &                     &       0.002         &                     &      -0.000         \\
\hs  \X initial assets (10,000 TZS)                    &                     &     (0.003)         &                     &     (0.002)         &                     &     (0.003)         \\
\addlinespace 
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Woman fixed effects                                    &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Observations                                           &    \mco{988}        &    \mco{988}        &    \mco{988}        &    \mco{988}        &    \mco{988}        &    \mco{988}        \\
Number of women                                        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        \\
\bottomrule
\end{tabular}
...
\begin{small}
\begin{threeparttable}
\caption{The Effects of Crop Loss on Contraceptives Use by Assets}
\label{tab:assets}
\begin{tabular}{@{} l D{.}{.}{1.5} D{.}{.}{1.5}  D{.}{.}{1.5} D{.}{.}{1.5} D{.}{.}{1.5}  @{}}
\toprule
                                                       & \mco{}              &\mco{}               &\multicolumn{3}{c}{Contraceptive Use}\\ \cmidrule(lr){4-6}
                                                       & \mco{Pregnant}      &\mco{Childbirth}     &\mco{Any}            &\mco{Traditional}    & \mco{Modern}        \\ \midrule
Crop loss - 1-7 months (200 TZS or above)              &      -0.095\sym{**} &                     &       0.093\sym{**} &       0.065\sym{**} &       0.021         \\
                                                       &     (0.045)         &                     &     (0.037)         &     (0.032)         &     (0.015)         \\
Crop loss - 1-7 months                                 &       0.000         &                     &      -0.003         &      -0.001         &      -0.002         \\
\hs \X initial assets (10,000 TZS)                     &     (0.001)         &                     &     (0.003)         &     (0.003)         &     (0.002)         \\
Crop loss - 7-14 months (200 TZS or above)             &                     &      -0.164\sym{***}&                     &                     &                     \\
                                                       &                     &     (0.053)         &                     &                     &                     \\
Crop loss - 7-14 months                                &                     &       0.001         &                     &                     &                     \\
\hs \X initial assets (10,000 TZS)                     &                     &     (0.002)         &                     &                     &                     \\
\addlinespace 
...
\begin{small}
\begin{threeparttable}
\caption{The Effects of Crop Loss on Contraceptives Use by Education Level}
\label{tab:education}
\begin{tabular}{@{} l D{.}{.}{1.5} D{.}{.}{1.5}  D{.}{.}{1.5} D{.}{.}{1.5} D{.}{.}{1.5}  @{}}
\toprule
                                                       & \mco{}              &\mco{}               &\multicolumn{3}{c}{Contraceptive Use}\\ \cmidrule(lr){4-6}
                                                       & \mco{Pregnant}      &\mco{Birth}          &\mco{Any}            &\mco{Traditional}    & \mco{Modern}        \\ \midrule
                                                       & \multicolumn{5}{c}{Respondent's education level} \\
Crop loss \X no education                              &      -0.069         &                     &       0.080         &       0.041         &       0.032         \\
                                                       &     (0.062)         &                     &     (0.051)         &     (0.041)         &     (0.029)         \\
Crop loss \X 1-6 years of education                    &      -0.006         &                     &       0.019         &       0.036         &      -0.033         \\
                                                       &     (0.063)         &                     &     (0.051)         &     (0.040)         &     (0.031)         \\
Crop loss \X 7 plus years of education                 &      -0.167\sym{***}&                     &       0.098\sym{**} &       0.073\sym{*}  &       0.009         \\
                                                       &     (0.050)         &                     &     (0.043)         &     (0.039)         &     (0.018)         \\
...
% Number of women                                        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        \\
\addlinespace 
                                                       & \multicolumn{5}{c}{Head's education level} \\
...
% \addlinespace 
% Observations                                           &    \mco{964}        &    \mco{723}        &    \mco{964}        &    \mco{964}        &    \mco{964}        \\
% Number of women                                        &    \mco{241}        &    \mco{241}        &    \mco{241}        &    \mco{241}        &    \mco{241}        \\
% \addlinespace 
%                                                        & \multicolumn{5}{c}{Maximum education level in household} \\
% Crop loss \X no education                              &      -0.396\sym{***}&                     &       0.503         &       0.494         &       0.005         \\
%                                                        &     (0.026)         &                     &     (0.371)         &     (0.372)         &     (0.012)         \\
% Crop loss \X 1-6 years of education                    &      -0.016         &                     &       0.067         &       0.032         &       0.011         \\
%                                                        &     (0.065)         &                     &     (0.069)         &     (0.053)         &     (0.045)         \\
% Crop loss \X 7 plus years of education                 &      -0.114\sym{**} &                     &       0.064\sym{**} &       0.054\sym{**} &       0.000         \\
%                                                        &     (0.046)         &                     &     (0.032)         &     (0.026)         &     (0.014)         \\
% Crop loss (7-14 months)                                &                     &      -0.322\sym{*}  &                     &                     &                     \\
% \hs \X no education                                    &                     &     (0.176)         &                     &                     &                     \\
% Crop loss (7-14 months)                                &                     &      -0.118\sym{*}  &                     &                     &                     \\
% \hs \X 1-6 years of education                          &                     &     (0.071)         &                     &                     &                     \\
% Crop loss (7-14 months)                                &                     &      -0.170\sym{***}&                     &                     &                     \\
% \hs \X 7 plus years of education                       &                     &     (0.054)         &                     &                     &                     \\
\addlinespace 
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Woman fixed effects                                    &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Observations                                           &    \mco{988}        &    \mco{741}        &    \mco{988}        &    \mco{988}        &    \mco{988}        \\
...
\begin{small}
\begin{threeparttable}
\caption{The Effects of Individual and Village Crop Loss}
\label{tab:vill_croploss}
\begin{tabular}{@{} l D{.}{.}{1.5} D{.}{.}{1.5}  D{.}{.}{1.5} D{.}{.}{1.5} D{.}{.}{1.5}  @{}}
\toprule
                                                       & \mco{}              &\mco{}               &\multicolumn{3}{c}{Contraceptive Use}\\ \cmidrule(lr){4-6}
                                                       & \mco{Pregnant}      &\mco{Birth}          &\mco{Any}            &\mco{Traditional}    & \mco{Modern}        \\ \midrule
Crop loss - 1-7 months (200 TZS or above)              &      -0.105\sym{**} &                     &       0.071\sym{**} &       0.047\sym{**} &       0.006         \\
                                                       &     (0.049)         &                     &     (0.032)         &     (0.023)         &     (0.021)         \\
Fraction with crop loss in village                     &       0.059         &                     &      -0.003         &       0.030         &      -0.013         \\
                                                       &     (0.108)         &                     &     (0.070)         &     (0.056)         &     (0.039)         \\
Crop loss - 7-14 months (200 TZS or above)             &                     &      -0.152\sym{***}&                     &                     &                     \\
                                                       &                     &     (0.058)         &                     &                     &                     \\
Lagged fraction with crop loss in village              &                     &      -0.033         &                     &                     &                     \\
                                                       &                     &     (0.120)         &                     &                     &                     \\
\addlinespace 
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Woman fixed effects                                    &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
...
\begin{tabular}{@{} l D{.}{.}{2.6}  D{.}{.}{2.6} D{.}{.}{2.6} D{.}{.}{2.6} @{}}
\toprule
                                                       &\multicolumn{2}{c}{Crop loss - Dummy }& \multicolumn{2}{c}{} \\
                                                       &\multicolumn{2}{c}{200 TZS or above}       & \multicolumn{2}{c}{Log crop loss} \\ \midrule
                                                       & \multicolumn{4}{c}{Prior contraceptive use} \\
...
Used contraceptives prior survey \X initial assets     &                     &      -0.001         &                     &      -0.000         \\
                                                       &                     &     (0.002)         &                     &     (0.000)         \\
\addlinespace 
                                                       & \multicolumn{4}{c}{Prior pregnancy} \\
...
Pregnant prior survey \X initial assets                &                     &       0.003         &                     &       0.000         \\
                                                       &                     &     (0.002)         &                     &     (0.000)         \\
\addlinespace 
                                                       & \multicolumn{4}{c}{Prior birth} \\
Gave birth 7-14 months ago                             &      -0.034         &      -0.010         &      -0.002         &       0.003         \\
                                                       &     (0.029)         &     (0.031)         &     (0.007)         &     (0.008)         \\
Birth prior survey \X initial assets                   &                     &      -0.003\sym{**} &                     &      -0.001\sym{***}\\
                                                       &                     &     (0.001)         &                     &     (0.000)         \\
\addlinespace 
Wave dummies                                           &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Woman fixed effects                                    &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        &    \mco{Yes}        \\
Observations                                           &    \mco{741}        &    \mco{741}        &    \mco{741}        &    \mco{741}        \\
Number of women                                        &    \mco{247}        &    \mco{247}        &    \mco{247}        &    \mco{247}        \\
\bottomrule
\end{tabular}
\begin{tablenotes} \footnotesize
\item \hspace*{-0.5em} \textbf{Note.}
Each panel a separate regression. 
Two left columns are linear probability models and two right columns 
are linear models.
Robust standard errors clustered at household level in parentheses; 
* significant at 10\%; ** significant at 5\%; *** significant at 1\%.
Crop loss is a dummy for a per capita crop loss of 200 TZS or above.
