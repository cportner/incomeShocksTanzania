...
Although we cannot directly measure stress, we do have information 
...
As the cut-off becomes very large significance is lower
...
We have reduced the use of causal language throughout the paper and
...
one that use the prior growing for waves 2 through 4 and the last two prior 
growing seasons for wave 1 (given that wave 1 has a recall period 
of 12 months).
